...
You cannot read a table whose columns are explained below it, so the
legend comes before four minutes of output rather than after it.
"""
...
def print_why(summary: RunSummary) -> None:
    ...
    flagged and held back alike, uncapped. The suppressed names are
