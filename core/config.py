...
# was launched from -- a wrong working directory would otherwise turn
...
def fiscal_years(fy0: int | None = None) -> list[int]:
    ...
    if fy0 is None:
        ...
        if years:
            ...
            # is five items, sorted, and still skips 2022 -- exactly the
            # mismatched-window failure mode this module exists to rule out.
